...
public:
	...
	void UpdateTimeAndExecute()
	{
		...
		if (currtime.getDateTime(Electrux::SlicedTime::Data::MINUTES) > prevtime.getDateTime(Electrux::SlicedTime::Data::MINUTES) || currtime.getDateTime(Electrux::SlicedTime::Data::MINUTES) == 0)
		{
