class Network
{
	...
	public:
		...
		int GetMsg(std::string &recvmsg)
		{
			...
			{
				packet >> msgtype;
				if (msgtype == MSG_TYPE::Authenticate || msgtype == MSG_TYPE::Command || msgtype == MSG_TYPE::Connected || msgtype == MSG_TYPE::Count || msgtype == MSG_TYPE::Group || msgtype == MSG_TYPE::System || msgtype == MSG_TYPE::Text)
				{
